...
type InboundMessagesApiService service

/* 
InboundMessagesApiService Delete the incoming message.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id


*/
func (a *InboundMessagesApiService) DeleteInboundMessage(ctx context.Context, id int32) (*http.Response, error) {
	var (
...
/* 
InboundMessagesApiService Delete inbound messages by given ID(s) or delete all inbound messages.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *InboundMessagesApiService) DeleteInboundMessagesBulk(ctx context.Context, deleteInboundMessagesBulkInputObject DeleteInboundMessagesBulkInputObject, localVarOptionals *DeleteInboundMessagesBulkOpts) (*http.Response, error) {
	var (
...
/* 
InboundMessagesApiService Get all inbox messages.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *InboundMessagesApiService) GetAllInboundMessages(ctx context.Context, localVarOptionals *GetAllInboundMessagesOpts) (map[string]interface{}, *http.Response, error) {
	var (
...
/* 
InboundMessagesApiService Get a single inbox message.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id

@return MessageIn
*/
func (a *InboundMessagesApiService) GetInboundMessage(ctx context.Context, id int32) (MessageIn, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
InboundMessagesApiService Find inbound messages by given parameters.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *InboundMessagesApiService) SearchInboundMessages(ctx context.Context, localVarOptionals *SearchInboundMessagesOpts) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
