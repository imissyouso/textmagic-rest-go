...
type ScheduledMessagesApiService service

/* 
ScheduledMessagesApiService Delete a message session, together with all nested messages.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id


*/
func (a *ScheduledMessagesApiService) DeleteScheduledMessage(ctx context.Context, id int32) (*http.Response, error) {
	var (
...
/* 
ScheduledMessagesApiService Delete scheduled messages by given ID(s) or delete all scheduled messages.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *ScheduledMessagesApiService) DeleteScheduledMessagesBulk(ctx context.Context, deleteScheduledMessagesBulkInputObject DeleteScheduledMessagesBulkInputObject, localVarOptionals *DeleteScheduledMessagesBulkOpts) (*http.Response, error) {
	var (
...
/* 
ScheduledMessagesApiService Get all scheduled messages.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *ScheduledMessagesApiService) GetAllScheduledMessages(ctx context.Context, localVarOptionals *GetAllScheduledMessagesOpts) (map[string]interface{}, *http.Response, error) {
	var (
...
/* 
ScheduledMessagesApiService Get message schedule.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id

@return MessagesIcs
*/
func (a *ScheduledMessagesApiService) GetScheduledMessage(ctx context.Context, id int32) (MessagesIcs, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ScheduledMessagesApiService Find scheduled messages by given parameters.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *ScheduledMessagesApiService) SearchScheduledMessages(ctx context.Context, localVarOptionals *SearchScheduledMessagesOpts) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
