...
/* 
TextMagicApiService Add an avatar for the current user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param image User avatar. Should be PNG or JPG file not more than 10 MB


*/
func (a *TextMagicApiService) UploadAvatar(ctx context.Context, image *os.File) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
TextMagicApiService Add an avatar for the contact.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
@return ResourceLinkResponse
*/
func (a *TextMagicApiService) UploadContactAvatar(ctx context.Context, image *os.File, id int32) (ResourceLinkResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
TextMagicApiService Add an avatar for the list.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
@return ResourceLinkResponse
*/
func (a *TextMagicApiService) UploadListAvatar(ctx context.Context, image *os.File, id int32) (ResourceLinkResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
TextMagicApiService Upload message attachment
...
*/
func (a *TextMagicApiService) UploadMessageAttachment(ctx context.Context, file *os.File) (UploadMessageAttachmentResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
