...
type ContactsImportApiService service

/* 
ContactsImportApiService Get contact import session progress.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id

@return GetContactImportSessionProgressResponse
*/
func (a *ContactsImportApiService) GetContactImportSessionProgress(ctx context.Context, id int32) (GetContactImportSessionProgressResponse, *http.Response, error) {
	var (
