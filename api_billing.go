...
/* 
BillingApiService Return account invoices.
...
func (a *BillingApiService) GetInvoices(ctx context.Context, localVarOptionals *GetInvoicesOpts) (map[string]interface{}, *http.Response, error) {
	var (
...
/* 
BillingApiService Return account spending statistics.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *BillingApiService) GetSpendingStat(ctx context.Context, localVarOptionals *GetSpendingStatOpts) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
